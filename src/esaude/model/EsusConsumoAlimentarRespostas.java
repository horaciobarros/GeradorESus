...
@Entity 
@Table(name="esus_consumo_alimentar_respostas")
public class EsusConsumoAlimentarRespostas implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "id_consumo_alimentar")
	...
	public int hashCode() {
		...
		result = prime * result + ((esusConsumoAlimentar == null) ? 0 : esusConsumoAlimentar.hashCode());
	...
	public boolean equals(Object obj) {
		...
		EsusConsumoAlimentarRespostas other = (EsusConsumoAlimentarRespostas) obj;
		...
		if (esusConsumoAlimentar == null){
			if (other.esusConsumoAlimentar!= null)
				return false;
		} else if (!esusConsumoAlimentar.equals(other.esusConsumoAlimentar)){
			return false;
		}
