...
public class EsusCadastroDomiciliar implements Serializable {
	...
	public void setEsusSituacaodemoradia(
			EsusSituacaodemoradia esusSituacaodemoradia) {
	...
	public void setEsusLocalizacaodamoradia(
			EsusLocalizacaodamoradia esusLocalizacaodamoradia) {
	...
	public void setEsusTipodeacessoaodomicilio(
			EsusTipodeacessoaodomicilio esusTipodeacessoaodomicilio) {
	...
	public void setEsusMaterialpredominantenaconstrucao(
			EsusMaterialpredominantenaconstrucao esusMaterialpredominantenaconstrucao) {
	...
	public void setEsusCondicaodeposseeusodaterra(
			EsusCondicaodeposseeusodaterra esusCondicaodeposseeusodaterra) {
	...
	public void setEsusAbastecimentodeagua(
			EsusAbastecimentodeagua esusAbastecimentodeagua) {
	...
	public void setEsusTratamentodeaguanodomicilio(
			EsusTratamentodeaguanodomicilio esusTratamentodeaguanodomicilio) {
	...
	public void setEsusFormadeescoamentodobanheiroousanitario(
			EsusFormadeescoamentodobanheiroousanitario esusFormadeescoamentodobanheiroousanitario) {
