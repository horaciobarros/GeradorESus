...
public class PProntuario implements Serializable {
   ...
   public void  setCnesEstabelecimentos(CnesEstabelecimentos cnesEstabelecimentos) { 
   ...
   public Long getMaeDesconhecida() { 
      return maeDesconhecida;
   }
   public void  setMaeDesconhecida(Long maeDesconhecida) { 
