...
@Entity 
@Table(name="esus_cadastro_individual_deficienciascidadao")
public class EsusCadastroIndividualDeficienciascidadao implements Serializable {
   ...
   @ManyToOne
   @JoinColumn(name = "id_deficienciacidadao")
   ...
   public boolean equals(Object obj) {
      ...
      return false;
      EsusCadastroIndividualDeficienciascidadao other = (EsusCadastroIndividualDeficienciascidadao) obj;
      if (id == null) {
