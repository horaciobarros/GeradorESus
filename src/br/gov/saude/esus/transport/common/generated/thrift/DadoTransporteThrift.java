 ...
 */
public class DadoTransporteThrift implements org.apache.thrift.TBase<DadoTransporteThrift, DadoTransporteThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.COD_IBGE,_Fields.INE_DADO_SERIALIZADO,_Fields.NUM_LOTE,_Fields.VERSAO};
...
;
  ...
  public void setDadoSerializado(byte[] dadoSerializado) {
    setDadoSerializado(dadoSerializado == null ? (ByteBuffer)null : ByteBuffer.wrap(dadoSerializado));
  }
  ...
  public int compareTo(DadoTransporteThrift other) {
    ...
    DadoTransporteThrift typedOther = (DadoTransporteThrift)other;

    lastComparison = Boolean.valueOf(isSetUuidDadoSerializado()).compareTo(typedOther.isSetUuidDadoSerializado());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUuidDadoSerializado()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.uuidDadoSerializado, typedOther.uuidDadoSerializado);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetTipoDadoSerializado()).compareTo(typedOther.isSetTipoDadoSerializado());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTipoDadoSerializado()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.tipoDadoSerializado, typedOther.tipoDadoSerializado);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCnesDadoSerializado()).compareTo(typedOther.isSetCnesDadoSerializado());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCnesDadoSerializado()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cnesDadoSerializado, typedOther.cnesDadoSerializado);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCodIbge()).compareTo(typedOther.isSetCodIbge());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCodIbge()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.codIbge, typedOther.codIbge);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetIneDadoSerializado()).compareTo(typedOther.isSetIneDadoSerializado());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIneDadoSerializado()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ineDadoSerializado, typedOther.ineDadoSerializado);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumLote()).compareTo(typedOther.isSetNumLote());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumLote()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numLote, typedOther.numLote);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDadoSerializado()).compareTo(typedOther.isSetDadoSerializado());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDadoSerializado()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dadoSerializado, typedOther.dadoSerializado);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRemetente()).compareTo(typedOther.isSetRemetente());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRemetente()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.remetente, typedOther.remetente);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetOriginadora()).compareTo(typedOther.isSetOriginadora());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOriginadora()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.originadora, typedOther.originadora);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
