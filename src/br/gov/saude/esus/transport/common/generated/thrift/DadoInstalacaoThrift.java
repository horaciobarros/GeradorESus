 ...
 */
public class DadoInstalacaoThrift implements org.apache.thrift.TBase<DadoInstalacaoThrift, DadoInstalacaoThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.UUID_INSTALACAO,_Fields.FONE,_Fields.EMAIL};
  ...
  public int compareTo(DadoInstalacaoThrift other) {
    ...
    DadoInstalacaoThrift typedOther = (DadoInstalacaoThrift)other;

    lastComparison = Boolean.valueOf(isSetContraChave()).compareTo(typedOther.isSetContraChave());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetContraChave()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.contraChave, typedOther.contraChave);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetUuidInstalacao()).compareTo(typedOther.isSetUuidInstalacao());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUuidInstalacao()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.uuidInstalacao, typedOther.uuidInstalacao);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCpfOuCnpj()).compareTo(typedOther.isSetCpfOuCnpj());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCpfOuCnpj()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cpfOuCnpj, typedOther.cpfOuCnpj);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNomeOuRazaoSocial()).compareTo(typedOther.isSetNomeOuRazaoSocial());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNomeOuRazaoSocial()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nomeOuRazaoSocial, typedOther.nomeOuRazaoSocial);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetFone()).compareTo(typedOther.isSetFone());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFone()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.fone, typedOther.fone);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
