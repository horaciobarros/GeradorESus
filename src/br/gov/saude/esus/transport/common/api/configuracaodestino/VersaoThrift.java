...
public class VersaoThrift implements org.apache.thrift.TBase<VersaoThrift, VersaoThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(VersaoThrift other) {
    ...
    VersaoThrift typedOther = (VersaoThrift)other;
