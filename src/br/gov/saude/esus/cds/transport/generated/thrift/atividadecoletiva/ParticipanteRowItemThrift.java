...
public class ParticipanteRowItemThrift implements org.apache.thrift.TBase<ParticipanteRowItemThrift, ParticipanteRowItemThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.CNS,_Fields.DATA_NASCIMENTO,_Fields.AVALIACAO_ALTERADA,_Fields.PESO,_Fields.ALTURA,_Fields.CESSOU_HABITO_FUMAR,_Fields.ABANDONOU_GRUPO};
  ...
  public int compareTo(ParticipanteRowItemThrift other) {
    ...
    ParticipanteRowItemThrift typedOther = (ParticipanteRowItemThrift)other;
    ...
    lastComparison = Boolean.valueOf(isSetAvaliacaoAlterada()).compareTo(typedOther.isSetAvaliacaoAlterada());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAvaliacaoAlterada()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.avaliacaoAlterada, typedOther.avaliacaoAlterada);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetAltura()).compareTo(typedOther.isSetAltura());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAltura()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.altura, typedOther.altura);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCessouHabitoFumar()).compareTo(typedOther.isSetCessouHabitoFumar());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCessouHabitoFumar()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cessouHabitoFumar, typedOther.cessouHabitoFumar);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAbandonouGrupo()).compareTo(typedOther.isSetAbandonouGrupo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAbandonouGrupo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.abandonouGrupo, typedOther.abandonouGrupo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
