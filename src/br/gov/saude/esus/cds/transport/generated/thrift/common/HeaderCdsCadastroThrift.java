...
public class HeaderCdsCadastroThrift implements org.apache.thrift.TBase<HeaderCdsCadastroThrift, HeaderCdsCadastroThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.CNS_PROFISSIONAL,_Fields.CODIGO_IBGE_MUNICIPIO,_Fields.DATA_ATENDIMENTO,_Fields.INE_EQUIPE,_Fields.MICROAREA};
  ...
  public int compareTo(HeaderCdsCadastroThrift other) {
    ...
    HeaderCdsCadastroThrift typedOther = (HeaderCdsCadastroThrift)other;

    lastComparison = Boolean.valueOf(isSetCnesUnidadeSaude()).compareTo(typedOther.isSetCnesUnidadeSaude());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCnesUnidadeSaude()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cnesUnidadeSaude, typedOther.cnesUnidadeSaude);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCnsProfissional()).compareTo(typedOther.isSetCnsProfissional());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCnsProfissional()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cnsProfissional, typedOther.cnsProfissional);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetIneEquipe()).compareTo(typedOther.isSetIneEquipe());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIneEquipe()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ineEquipe, typedOther.ineEquipe);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
