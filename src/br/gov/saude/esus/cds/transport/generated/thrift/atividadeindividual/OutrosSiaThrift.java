...
public class OutrosSiaThrift implements org.apache.thrift.TBase<OutrosSiaThrift, OutrosSiaThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.CODIGO_EXAME,_Fields.SOLICITADO_AVALIADO};
  ...
  public OutrosSiaThrift(OutrosSiaThrift other) {
    ...
    if (other.isSetSolicitadoAvaliado()) {
      List<String> __this__solicitadoAvaliado = new ArrayList<String>();
      for (String other_element : other.solicitadoAvaliado) {
        __this__solicitadoAvaliado.add(other_element);
      }
  ...
  public int compareTo(OutrosSiaThrift other) {
    ...
    OutrosSiaThrift typedOther = (OutrosSiaThrift)other;

    lastComparison = Boolean.valueOf(isSetCodigoExame()).compareTo(typedOther.isSetCodigoExame());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCodigoExame()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.codigoExame, typedOther.codigoExame);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetSolicitadoAvaliado()).compareTo(typedOther.isSetSolicitadoAvaliado());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSolicitadoAvaliado()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.solicitadoAvaliado, typedOther.solicitadoAvaliado);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  ...
                  struct.solicitadoAvaliado.add(_elem2);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            ...
            struct.solicitadoAvaliado.add(_elem7);
          }
        }
        struct.setSolicitadoAvaliadoIsSet(true);
      }
