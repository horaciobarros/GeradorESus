...
public class EnderecoLocalPermanenciaThrift implements org.apache.thrift.TBase<EnderecoLocalPermanenciaThrift, EnderecoLocalPermanenciaThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.BAIRRO,_Fields.CEP,_Fields.CODIGO_IBGE_MUNICIPIO,_Fields.COMPLEMENTO,_Fields.NOME_LOGRADOURO,_Fields.NUMERO,_Fields.NUMERO_DNE_UF,_Fields.TEL_REFERENCIAL,_Fields.TEL_RESIDENCIAL,_Fields.TIPO_LOGRADOURO_NUMERO_DNE};
  ...
  public int compareTo(EnderecoLocalPermanenciaThrift other) {
    ...
    EnderecoLocalPermanenciaThrift typedOther = (EnderecoLocalPermanenciaThrift)other;

    lastComparison = Boolean.valueOf(isSetBairro()).compareTo(typedOther.isSetBairro());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBairro()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bairro, typedOther.bairro);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCep()).compareTo(typedOther.isSetCep());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCep()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cep, typedOther.cep);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetNomeLogradouro()).compareTo(typedOther.isSetNomeLogradouro());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNomeLogradouro()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nomeLogradouro, typedOther.nomeLogradouro);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetNumeroDneUf()).compareTo(typedOther.isSetNumeroDneUf());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumeroDneUf()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numeroDneUf, typedOther.numeroDneUf);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetTelReferencial()).compareTo(typedOther.isSetTelReferencial());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTelReferencial()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.telReferencial, typedOther.telReferencial);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetTelResidencial()).compareTo(typedOther.isSetTelResidencial());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTelResidencial()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.telResidencial, typedOther.telResidencial);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetTipoLogradouroNumeroDne()).compareTo(typedOther.isSetTipoLogradouroNumeroDne());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTipoLogradouroNumeroDne()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.tipoLogradouroNumeroDne, typedOther.tipoLogradouroNumeroDne);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
