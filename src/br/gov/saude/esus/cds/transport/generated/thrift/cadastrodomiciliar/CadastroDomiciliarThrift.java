...
public class CadastroDomiciliarThrift implements org.apache.thrift.TBase<CadastroDomiciliarThrift, CadastroDomiciliarThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private EnderecoLocalPermanenciaThrift enderecoLocalPermanencia; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.ENDERECO_LOCAL_PERMANENCIA, new org.apache.thrift.meta_data.FieldMetaData("enderecoLocalPermanencia", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, EnderecoLocalPermanenciaThrift.class)));
  ...
  public CadastroDomiciliarThrift(CadastroDomiciliarThrift other) {
    ...
    if (other.isSetAnimaisNoDomicilio()) {
      List<Long> __this__animaisNoDomicilio = new ArrayList<Long>();
      for (Long other_element : other.animaisNoDomicilio) {
        __this__animaisNoDomicilio.add(other_element);
      }
    ...
    if (other.isSetEnderecoLocalPermanencia()) {
      this.enderecoLocalPermanencia = new EnderecoLocalPermanenciaThrift(other.enderecoLocalPermanencia);
    }
    if (other.isSetFamilias()) {
      List<FamiliaRowThrift> __this__familias = new ArrayList<FamiliaRowThrift>();
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ENDERECO_LOCAL_PERMANENCIA:
      if (value == null) {
        ...
        setEnderecoLocalPermanencia((EnderecoLocalPermanenciaThrift)value);
      }
      break;
  ...
  public int compareTo(CadastroDomiciliarThrift other) {
    ...
    CadastroDomiciliarThrift typedOther = (CadastroDomiciliarThrift)other;

    lastComparison = Boolean.valueOf(isSetAnimaisNoDomicilio()).compareTo(typedOther.isSetAnimaisNoDomicilio());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAnimaisNoDomicilio()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.animaisNoDomicilio, typedOther.animaisNoDomicilio);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCondicaoMoradia()).compareTo(typedOther.isSetCondicaoMoradia());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCondicaoMoradia()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.condicaoMoradia, typedOther.condicaoMoradia);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDadosGerais()).compareTo(typedOther.isSetDadosGerais());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDadosGerais()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dadosGerais, typedOther.dadosGerais);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetEnderecoLocalPermanencia()).compareTo(typedOther.isSetEnderecoLocalPermanencia());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnderecoLocalPermanencia()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.enderecoLocalPermanencia, typedOther.enderecoLocalPermanencia);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetFamilias()).compareTo(typedOther.isSetFamilias());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFamilias()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.familias, typedOther.familias);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetFichaAtualizada()).compareTo(typedOther.isSetFichaAtualizada());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFichaAtualizada()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.fichaAtualizada, typedOther.fichaAtualizada);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetQuantosAnimaisNoDomicilio()).compareTo(typedOther.isSetQuantosAnimaisNoDomicilio());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQuantosAnimaisNoDomicilio()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.quantosAnimaisNoDomicilio, typedOther.quantosAnimaisNoDomicilio);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetStAnimaisNoDomicilio()).compareTo(typedOther.isSetStAnimaisNoDomicilio());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStAnimaisNoDomicilio()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stAnimaisNoDomicilio, typedOther.stAnimaisNoDomicilio);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetStatusTermoRecusaCadastroDomiciliarAtencaoBasica()).compareTo(typedOther.isSetStatusTermoRecusaCadastroDomiciliarAtencaoBasica());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStatusTermoRecusaCadastroDomiciliarAtencaoBasica()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.statusTermoRecusaCadastroDomiciliarAtencaoBasica, typedOther.statusTermoRecusaCadastroDomiciliarAtencaoBasica);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, CadastroDomiciliarThrift struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  ...
                  struct.animaisNoDomicilio.add(_elem2);
                }
                iprot.readListEnd();
              }
          ...
          case 4: // ENDERECO_LOCAL_PERMANENCIA
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.enderecoLocalPermanencia = new EnderecoLocalPermanenciaThrift();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  FamiliaRowThrift _elem5; // required
                  _elem5 = new FamiliaRowThrift();
                  _elem5.read(iprot);
                  struct.familias.add(_elem5);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i11 = 0; _i11 < _list10.size; ++_i11)
          {
            ...
            struct.animaisNoDomicilio.add(_elem12);
          }
        }
        struct.setAnimaisNoDomicilioIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          {
            FamiliaRowThrift _elem15; // required
            _elem15 = new FamiliaRowThrift();
            _elem15.read(iprot);
            struct.familias.add(_elem15);
          }
        }
        struct.setFamiliasIsSet(true);
      }
