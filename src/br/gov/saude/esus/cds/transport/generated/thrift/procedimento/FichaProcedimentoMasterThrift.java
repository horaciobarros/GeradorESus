...
public class FichaProcedimentoMasterThrift implements org.apache.thrift.TBase<FichaProcedimentoMasterThrift, FichaProcedimentoMasterThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  public FichaProcedimentoMasterThrift(FichaProcedimentoMasterThrift other) {
    ...
    if (other.isSetAtendProcedimentos()) {
      List<FichaProcedimentoChildThrift> __this__atendProcedimentos = new ArrayList<FichaProcedimentoChildThrift>();
  ...
  public int compareTo(FichaProcedimentoMasterThrift other) {
    ...
    FichaProcedimentoMasterThrift typedOther = (FichaProcedimentoMasterThrift)other;
    ...
    lastComparison = Boolean.valueOf(isSetAtendProcedimentos()).compareTo(typedOther.isSetAtendProcedimentos());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAtendProcedimentos()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.atendProcedimentos, typedOther.atendProcedimentos);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumTotalAfericaoPa()).compareTo(typedOther.isSetNumTotalAfericaoPa());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumTotalAfericaoPa()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numTotalAfericaoPa, typedOther.numTotalAfericaoPa);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumTotalGlicemiaCapilar()).compareTo(typedOther.isSetNumTotalGlicemiaCapilar());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumTotalGlicemiaCapilar()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numTotalGlicemiaCapilar, typedOther.numTotalGlicemiaCapilar);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumTotalAfericaoTemperatura()).compareTo(typedOther.isSetNumTotalAfericaoTemperatura());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumTotalAfericaoTemperatura()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numTotalAfericaoTemperatura, typedOther.numTotalAfericaoTemperatura);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumTotalMedicaoAltura()).compareTo(typedOther.isSetNumTotalMedicaoAltura());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumTotalMedicaoAltura()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numTotalMedicaoAltura, typedOther.numTotalMedicaoAltura);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumTotalCurativoSimples()).compareTo(typedOther.isSetNumTotalCurativoSimples());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumTotalCurativoSimples()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numTotalCurativoSimples, typedOther.numTotalCurativoSimples);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumTotalMedicaoPeso()).compareTo(typedOther.isSetNumTotalMedicaoPeso());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumTotalMedicaoPeso()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numTotalMedicaoPeso, typedOther.numTotalMedicaoPeso);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumTotalColetaMaterialParaExameLaboratorial()).compareTo(typedOther.isSetNumTotalColetaMaterialParaExameLaboratorial());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumTotalColetaMaterialParaExameLaboratorial()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numTotalColetaMaterialParaExameLaboratorial, typedOther.numTotalColetaMaterialParaExameLaboratorial);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  FichaProcedimentoChildThrift _elem18; // required
                  _elem18 = new FichaProcedimentoChildThrift();
                  _elem18.read(iprot);
                  struct.atendProcedimentos.add(_elem18);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          {
            FichaProcedimentoChildThrift _elem23; // required
            _elem23 = new FichaProcedimentoChildThrift();
            _elem23.read(iprot);
            struct.atendProcedimentos.add(_elem23);
          }
        }
        struct.setAtendProcedimentosIsSet(true);
      }
