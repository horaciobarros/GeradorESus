...
public class CadastroIndividualThrift implements org.apache.thrift.TBase<CadastroIndividualThrift, CadastroIndividualThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.CONDICOES_DE_SAUDE,_Fields.EM_SITUACAO_DE_RUA,_Fields.FICHA_ATUALIZADA,_Fields.IDENTIFICACAO_USUARIO_CIDADAO,_Fields.INFORMACOES_SOCIO_DEMOGRAFICAS,_Fields.STATUS_TERMO_RECUSA_CADASTRO_INDIVIDUAL_ATENCAO_BASICA,_Fields.TP_CDS_ORIGEM};
  ...
  public int compareTo(CadastroIndividualThrift other) {
    ...
    CadastroIndividualThrift typedOther = (CadastroIndividualThrift)other;

    lastComparison = Boolean.valueOf(isSetCondicoesDeSaude()).compareTo(typedOther.isSetCondicoesDeSaude());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCondicoesDeSaude()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.condicoesDeSaude, typedOther.condicoesDeSaude);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetEmSituacaoDeRua()).compareTo(typedOther.isSetEmSituacaoDeRua());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEmSituacaoDeRua()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.emSituacaoDeRua, typedOther.emSituacaoDeRua);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetIdentificacaoUsuarioCidadao()).compareTo(typedOther.isSetIdentificacaoUsuarioCidadao());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIdentificacaoUsuarioCidadao()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.identificacaoUsuarioCidadao, typedOther.identificacaoUsuarioCidadao);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetInformacoesSocioDemograficas()).compareTo(typedOther.isSetInformacoesSocioDemograficas());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInformacoesSocioDemograficas()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.informacoesSocioDemograficas, typedOther.informacoesSocioDemograficas);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetStatusTermoRecusaCadastroIndividualAtencaoBasica()).compareTo(typedOther.isSetStatusTermoRecusaCadastroIndividualAtencaoBasica());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStatusTermoRecusaCadastroIndividualAtencaoBasica()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.statusTermoRecusaCadastroIndividualAtencaoBasica, typedOther.statusTermoRecusaCadastroIndividualAtencaoBasica);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
