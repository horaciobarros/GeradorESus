...
public class FichaVisitaDomiciliarMasterThrift implements org.apache.thrift.TBase<FichaVisitaDomiciliarMasterThrift, FichaVisitaDomiciliarMasterThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.TP_CDS_ORIGEM,_Fields.VISITAS_DOMICILIARES};
  ...
  public FichaVisitaDomiciliarMasterThrift(FichaVisitaDomiciliarMasterThrift other) {
    ...
    if (other.isSetVisitasDomiciliares()) {
      List<FichaVisitaDomiciliarChildThrift> __this__visitasDomiciliares = new ArrayList<FichaVisitaDomiciliarChildThrift>();
  ...
  public int compareTo(FichaVisitaDomiciliarMasterThrift other) {
    ...
    FichaVisitaDomiciliarMasterThrift typedOther = (FichaVisitaDomiciliarMasterThrift)other;
    ...
    lastComparison = Boolean.valueOf(isSetVisitasDomiciliares()).compareTo(typedOther.isSetVisitasDomiciliares());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVisitasDomiciliares()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.visitasDomiciliares, typedOther.visitasDomiciliares);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  FichaVisitaDomiciliarChildThrift _elem10; // required
                  _elem10 = new FichaVisitaDomiciliarChildThrift();
                  _elem10.read(iprot);
                  struct.visitasDomiciliares.add(_elem10);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          {
            FichaVisitaDomiciliarChildThrift _elem15; // required
            _elem15 = new FichaVisitaDomiciliarChildThrift();
            _elem15.read(iprot);
            struct.visitasDomiciliares.add(_elem15);
          }
        }
        struct.setVisitasDomiciliaresIsSet(true);
      }
