...
public class ProfissionalCboRowItemThrift implements org.apache.thrift.TBase<ProfissionalCboRowItemThrift, ProfissionalCboRowItemThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.CNS,_Fields.CODIGO_CBO2002};
  ...
  public int compareTo(ProfissionalCboRowItemThrift other) {
    ...
    ProfissionalCboRowItemThrift typedOther = (ProfissionalCboRowItemThrift)other;
    ...
    lastComparison = Boolean.valueOf(isSetCodigoCbo2002()).compareTo(typedOther.isSetCodigoCbo2002());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCodigoCbo2002()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.codigoCbo2002, typedOther.codigoCbo2002);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
