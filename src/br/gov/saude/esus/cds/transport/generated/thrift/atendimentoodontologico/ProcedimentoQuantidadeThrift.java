...
public class ProcedimentoQuantidadeThrift implements org.apache.thrift.TBase<ProcedimentoQuantidadeThrift, ProcedimentoQuantidadeThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.CO_MS_PROCEDIMENTO,_Fields.QUANTIDADE};
  ...
  public int compareTo(ProcedimentoQuantidadeThrift other) {
    ...
    ProcedimentoQuantidadeThrift typedOther = (ProcedimentoQuantidadeThrift)other;

    lastComparison = Boolean.valueOf(isSetCoMsProcedimento()).compareTo(typedOther.isSetCoMsProcedimento());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCoMsProcedimento()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.coMsProcedimento, typedOther.coMsProcedimento);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetQuantidade()).compareTo(typedOther.isSetQuantidade());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQuantidade()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.quantidade, typedOther.quantidade);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
