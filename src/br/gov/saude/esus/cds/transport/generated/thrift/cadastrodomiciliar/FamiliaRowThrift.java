...
public class FamiliaRowThrift implements org.apache.thrift.TBase<FamiliaRowThrift, FamiliaRowThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.DATA_NASCIMENTO_RESPONSAVEL,_Fields.NUMERO_CNS_RESPONSAVEL,_Fields.NUMERO_MEMBROS_FAMILIA,_Fields.NUMERO_PRONTUARIO,_Fields.RENDA_FAMILIAR,_Fields.RESIDE_DESDE,_Fields.ST_MUDANCA};
  ...
  public int compareTo(FamiliaRowThrift other) {
    ...
    FamiliaRowThrift typedOther = (FamiliaRowThrift)other;
    ...
    lastComparison = Boolean.valueOf(isSetNumeroCnsResponsavel()).compareTo(typedOther.isSetNumeroCnsResponsavel());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumeroCnsResponsavel()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numeroCnsResponsavel, typedOther.numeroCnsResponsavel);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumeroMembrosFamilia()).compareTo(typedOther.isSetNumeroMembrosFamilia());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumeroMembrosFamilia()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numeroMembrosFamilia, typedOther.numeroMembrosFamilia);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetRendaFamiliar()).compareTo(typedOther.isSetRendaFamiliar());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRendaFamiliar()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.rendaFamiliar, typedOther.rendaFamiliar);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetResideDesde()).compareTo(typedOther.isSetResideDesde());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetResideDesde()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.resideDesde, typedOther.resideDesde);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetStMudanca()).compareTo(typedOther.isSetStMudanca());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStMudanca()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stMudanca, typedOther.stMudanca);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
