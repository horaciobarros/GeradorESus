...
public class FichaAtendimentoOdontologicoMasterThrift implements org.apache.thrift.TBase<FichaAtendimentoOdontologicoMasterThrift, FichaAtendimentoOdontologicoMasterThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.ATENDIMENTOS_ODONTOLOGICOS,_Fields.TP_CDS_ORIGEM};
  ...
  public FichaAtendimentoOdontologicoMasterThrift(FichaAtendimentoOdontologicoMasterThrift other) {
    ...
    if (other.isSetAtendimentosOdontologicos()) {
      List<FichaAtendimentoOdontologicoChildThrift> __this__atendimentosOdontologicos = new ArrayList<FichaAtendimentoOdontologicoChildThrift>();
  ...
  public int compareTo(FichaAtendimentoOdontologicoMasterThrift other) {
    ...
    FichaAtendimentoOdontologicoMasterThrift typedOther = (FichaAtendimentoOdontologicoMasterThrift)other;
    ...
    lastComparison = Boolean.valueOf(isSetAtendimentosOdontologicos()).compareTo(typedOther.isSetAtendimentosOdontologicos());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAtendimentosOdontologicos()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.atendimentosOdontologicos, typedOther.atendimentosOdontologicos);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  FichaAtendimentoOdontologicoChildThrift _elem50; // required
                  _elem50 = new FichaAtendimentoOdontologicoChildThrift();
                  _elem50.read(iprot);
                  struct.atendimentosOdontologicos.add(_elem50);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            FichaAtendimentoOdontologicoChildThrift _elem55; // required
            _elem55 = new FichaAtendimentoOdontologicoChildThrift();
            _elem55.read(iprot);
            struct.atendimentosOdontologicos.add(_elem55);
          }
        }
        struct.setAtendimentosOdontologicosIsSet(true);
      }
