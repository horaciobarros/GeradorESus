...
public class FichaVisitaDomiciliarChildThrift implements org.apache.thrift.TBase<FichaVisitaDomiciliarChildThrift, FichaVisitaDomiciliarChildThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.TURNO,_Fields.NUM_PRONTUARIO,_Fields.NUM_CARTAO_SUS,_Fields.DT_NASCIMENTO,_Fields.SEXO,_Fields.STATUS_VISITA_COMPARTILHADA_OUTRO_PROFISSIONAL,_Fields.MOTIVOS_VISITA,_Fields.DESFECHO};
  ...
  public FichaVisitaDomiciliarChildThrift(FichaVisitaDomiciliarChildThrift other) {
    ...
    if (other.isSetMotivosVisita()) {
      List<Long> __this__motivosVisita = new ArrayList<Long>();
      for (Long other_element : other.motivosVisita) {
        __this__motivosVisita.add(other_element);
      }
  ...
  public int compareTo(FichaVisitaDomiciliarChildThrift other) {
    ...
    FichaVisitaDomiciliarChildThrift typedOther = (FichaVisitaDomiciliarChildThrift)other;
    ...
    lastComparison = Boolean.valueOf(isSetStatusVisitaCompartilhadaOutroProfissional()).compareTo(typedOther.isSetStatusVisitaCompartilhadaOutroProfissional());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStatusVisitaCompartilhadaOutroProfissional()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.statusVisitaCompartilhadaOutroProfissional, typedOther.statusVisitaCompartilhadaOutroProfissional);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetMotivosVisita()).compareTo(typedOther.isSetMotivosVisita());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMotivosVisita()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.motivosVisita, typedOther.motivosVisita);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDesfecho()).compareTo(typedOther.isSetDesfecho());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDesfecho()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.desfecho, typedOther.desfecho);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  ...
                  struct.motivosVisita.add(_elem2);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(6)) {
        {
          ...
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            ...
            struct.motivosVisita.add(_elem7);
          }
        }
        struct.setMotivosVisitaIsSet(true);
      }
