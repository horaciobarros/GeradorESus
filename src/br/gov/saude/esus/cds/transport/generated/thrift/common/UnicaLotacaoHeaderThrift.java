 ...
 */
public class UnicaLotacaoHeaderThrift implements org.apache.thrift.TBase<UnicaLotacaoHeaderThrift, UnicaLotacaoHeaderThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.PROFISSIONAL_CNS,_Fields.CBO_CODIGO_2002,_Fields.INE,_Fields.DATA_ATENDIMENTO,_Fields.CODIGO_IBGE_MUNICIPIO};
  ...
  public int compareTo(UnicaLotacaoHeaderThrift other) {
    ...
    UnicaLotacaoHeaderThrift typedOther = (UnicaLotacaoHeaderThrift)other;

    lastComparison = Boolean.valueOf(isSetProfissionalCNS()).compareTo(typedOther.isSetProfissionalCNS());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetProfissionalCNS()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.profissionalCNS, typedOther.profissionalCNS);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCboCodigo_2002()).compareTo(typedOther.isSetCboCodigo_2002());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCboCodigo_2002()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cboCodigo_2002, typedOther.cboCodigo_2002);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCnes()).compareTo(typedOther.isSetCnes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCnes()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cnes, typedOther.cnes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetIne()).compareTo(typedOther.isSetIne());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIne()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ine, typedOther.ine);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDataAtendimento()).compareTo(typedOther.isSetDataAtendimento());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDataAtendimento()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataAtendimento, typedOther.dataAtendimento);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
