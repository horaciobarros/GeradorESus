...
public class VariasLotacoesHeaderThrift implements org.apache.thrift.TBase<VariasLotacoesHeaderThrift, VariasLotacoesHeaderThrift._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.PROFISSIONAL_CNS1,_Fields.CBO_CODIGO_2002_1,_Fields.PROFISSIONAL_CNS2,_Fields.CBO_CODIGO_2002_2};
  ...
  public int compareTo(VariasLotacoesHeaderThrift other) {
    ...
    VariasLotacoesHeaderThrift typedOther = (VariasLotacoesHeaderThrift)other;

    lastComparison = Boolean.valueOf(isSetLotacaoForm()).compareTo(typedOther.isSetLotacaoForm());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLotacaoForm()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lotacaoForm, typedOther.lotacaoForm);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetProfissionalCNS1()).compareTo(typedOther.isSetProfissionalCNS1());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetProfissionalCNS1()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.profissionalCNS1, typedOther.profissionalCNS1);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCboCodigo_2002_1()).compareTo(typedOther.isSetCboCodigo_2002_1());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCboCodigo_2002_1()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cboCodigo_2002_1, typedOther.cboCodigo_2002_1);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetProfissionalCNS2()).compareTo(typedOther.isSetProfissionalCNS2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetProfissionalCNS2()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.profissionalCNS2, typedOther.profissionalCNS2);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCboCodigo_2002_2()).compareTo(typedOther.isSetCboCodigo_2002_2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCboCodigo_2002_2()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cboCodigo_2002_2, typedOther.cboCodigo_2002_2);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
